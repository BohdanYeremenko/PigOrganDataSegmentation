#!/bin/bash
#PBS -l select=1:ncpus=1:ngpus=1:mem=1=20gb:scratch_local=10gb:cl_adan=True
#PBS -l walltime=05:00:00 -q gpu
...
mkdir -p $SCRATCHDIR/data/processed/vis_predictions_mask
mkdir -p $OUTPUTDIR
